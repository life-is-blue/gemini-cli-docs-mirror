#!/usr/bin/env python3
"""Fetch markdown docs listed in configured llms.txt indexes."""
...
USER_AGENT = "cli-docs-mirror/1.0"
...
def fetch_text(url: str) -> str:
    ...
    for attempt in range(1, MAX_RETRIES + 1):
        # Prefer */* first: Cursor's /api/raw endpoint can 404 under narrower Accept values.
        ...
        try:
            ...
            last_error = exc
            # Retry transient failures, including occasional 404s from CDN edge misses.
