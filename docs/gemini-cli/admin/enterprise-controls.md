...
While [System-wide settings](/docs/cli/settings) act as convenient configuration
...
[Extensions](/docs/extensions) for more details.
...
[MCP Server Integration](/docs/tools/mcp-server) for more details.
...
control disables Agent Skills. See [Agent Skills](/docs/cli/skills) for more
details.